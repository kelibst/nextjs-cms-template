...
const TIMELINE = [
  { year: "1984", event: "Association founded for Disease Control Officers and Field Technicians." },
  { year: "2006", event: "Officially inaugurated at Korle-Bu, Accra as PUHTOG." },
  { year: "2009", event: "Re-named Ghana Association of Public Health Technical Officers (GAPHTO) at Cape Coast Conference." },
  { year: "Present", event: "Continues to advocate for public health professionals across Ghana." },
];
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-16">
        ...
        <section>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: about.background }}
          />
        </section>
