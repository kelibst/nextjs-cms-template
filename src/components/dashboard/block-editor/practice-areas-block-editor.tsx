...
import type { PracticeAreasContent } from '@/lib/blocks'

interface PracticeAreasBlockEditorProps {
  blockId: string
  initialContent: PracticeAreasContent
  onSave: (content: PracticeAreasContent) => Promise<void>
}

export function PracticeAreasBlockEditor({ blockId: _blockId, initialContent, onSave }: PracticeAreasBlockEditorProps) {
          ...
          <div key={i} className="border border-border rounded-lg p-3 space-y-2">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                placeholder="Practice area description"
                rows={2}
              />
            </div>
          </div>
